...
namespace SnowmireMVC.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        //        message.To.Add(new MailAddress("testmail@hotmail.com"));  // replace with valid value 
        //        message.From = new MailAddress("testmail@hotmail.com");  // replace with valid value
